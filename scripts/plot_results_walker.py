...
# Plot 1: Batch size comparison (mean ± std across seeds)
...
plt.tight_layout()
plt.savefig("results/figures/walker_batch_size_comparison.png", dpi=300, bbox_inches="tight")
print("Saved: results/figures/walker_batch_size_comparison.png")
plt.close()
...
for seed in SEEDS:
    ...
    if rewards is not None:
        plt.plot(episodes, rewards, label=f"Seed {seed}", linewidth=1.5, alpha=0.8)
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("results/figures/walker_seed_variability_batch256.png", dpi=300, bbox_inches="tight")
print("Saved: results/figures/walker_seed_variability_batch256.png")
plt.close()
